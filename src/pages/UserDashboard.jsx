...
const UserDashboard = () => {
  return (
    <div>
      ...
      <div className="px-6 pt-6 2xl:container">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <div className="py-8 h-full px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
              <h2 className="text-8xl text-center text-gray-700 merienda-800  ">
                {" "}
                0.00 <span className="text-lg -ml-6">TK</span>
              </h2>
              <p className="text-center text-2xl text-gray-500 font-bold merienda-800">
                Your Balance
              </p>
            </div>
          </div>
      ...
      {/* button section */}
      <div className="px-6 py-6 2xl:container flex gap-5 lg:flex-row flex-col">
        <button className="btn-primary btn text-white btn-lg px-16 text-xl font-bold merienda-800 ">
          Send Money
        </button>
        <button className="btn-info btn text-white btn-lg px-16 text-xl font-bold merienda-800 ">
          Cash In
        </button>
        <button className="btn-secondary btn text-white btn-lg px-16 text-xl font-bold merienda-800 ">
          Cash Out
        </button>
      </div>

      {/* Admin approval */}
      <div className="bg-gray-800 fixed top-0 z-50 w-full h-full bg-opacity-95 hidden items-center gap-4">
        <div className=" lg:ml-40 md:ml-20 ml-10 space-y-10">
          <h2 className="text-6xl font-bold  text-white">
            Wait for Admin approval
          </h2>
          <div className="flex gap-4 justify-center">
            <h2 className="text-5xl font-bold  text-white"> Status : </h2>
            <button className="btn btn-warning btn-lg text-xl ">Pending</button>
          </div>
        </div>
      </div>
    </div>
