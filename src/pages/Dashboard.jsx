    ...
    <section className="">
      ...
      <aside className="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        ...
        <div className="px-6 -mx-6 pt-2 flex justify-between items-center border-t">
          <button className="btn btn-ghost px-4 py-3 w-full flex items-center space-x-4 rounded-md text-gray-600 group">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
            ...
            <span onClick={handleLogout} className="group-hover:text-gray-700">
              Logout
            </span>
          </button>
        </div>
